...
public class Game {
	...
	private void initialize() {
		...
		frmRglesDuJeu.setSize(new Dimension (600, 400));
		...
		lblRglesDuJeu.setBounds(172, 23, 215, 47);
		...
		lblNewLabel.setBounds(20, 81, 564, 107);
		...
		lblCommentGagnerAu.setBounds(27, 191, 542, 169);
